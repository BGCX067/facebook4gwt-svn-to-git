...
public class ShareButton extends Widget {
	...
	private native void handleClick() /*-{
		u=this.@com.reveregroup.gwt.facebook4gwt.ShareButton::url;
		t=this.@com.reveregroup.gwt.facebook4gwt.ShareButton::title;
		$wnd.open('http://www.facebook.com/sharer.php?u='+encodeURIComponent(u)+'&t='+encodeURIComponent(t),'sharer','toolbar=0,status=0,width=626,height=436');
	}-*/;
}
